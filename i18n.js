(function () {
    ...
    var T = {
        ...
        'tagline.line2': {
            ...
            hr: 'Istraživanje ideja u kodu.',
            cs: 'Zkoumání nápadů v kódu.',
            da: 'Udforsker idéer i kode.',
            nl: 'Ideeën verkennen in code.',
            et: 'Ideede uurimine koodis.',
            fi: 'Ideoiden tutkimista koodissa.',
            fr: 'Explorer des idées en code.',
            de: 'Ideen im Code erkunden.',
            el: 'Εξερευνώντας ιδέες σε κώδικα.',
            hu: 'Ötletek felfedezése kódban.',
            ga: 'Ag iniúchadh smaointe i gcód.',
            it: 'Esplorare idee nel codice.',
            lv: 'Ideju izpēte kodā.',
            lt: 'Idėjų tyrinėjimas kode.',
            mt: 'Esplorazzjoni tal-ideat fil-kodiċi.',
            pl: 'Odkrywanie pomysłów w kodzie.',
            pt: 'Explorando ideias em código.',
            ro: 'Explorând idei în cod.',
            sk: 'Skúmanie nápadov v kóde.',
            sl: 'Raziskovanje idej v kodi.',
            es: 'Explorando ideas en código.',
            sv: 'Utforskar idéer i kod.'
        },
        'tagline.line3': {
            en: 'Software for thought, time, and play.',
            bg: 'Софтуер за мисъл, време и игра.',
            hr: 'Softver za razmišljanje, vrijeme i igru.',
            cs: 'Software pro myšlení, čas a hru.',
            da: 'Software til tanke, tid og leg.',
            nl: 'Software voor gedachte, tijd en spel.',
            et: 'Tarkvara mõtlemiseks, ajaks ja mänguks.',
            fi: 'Ohjelmistoja ajattelulle, ajalle ja leikille.',
            fr: 'Des logiciels pour la pensée, le temps et le jeu.',
            de: 'Software für Gedanken, Zeit und Spiel.',
            el: 'Λογισμικό για σκέψη, χρόνο και παιχνίδι.',
            hu: 'Szoftver gondolkodáshoz, időhöz és játékhoz.',
            ga: 'Bogearraí do smaointeoireacht, am, agus spraoi.',
            it: 'Software per il pensiero, il tempo e il gioco.',
            lv: 'Programmatūra domāšanai, laikam un rotaļām.',
            lt: 'Programinė įranga mąstymui, laikui ir žaidimui.',
            mt: 'Softwer għall-ħsieb, il-ħin, u l-logħob.',
            pl: 'Oprogramowanie dla myśli, czasu i zabawy.',
            pt: 'Software para o pensamento, o tempo e a diversão.',
            ro: 'Software pentru gândire, timp și joacă.',
            sk: 'Softvér pre myslenie, čas a hru.',
            sl: 'Programska oprema za razmišljanje, čas in igro.',
            es: 'Software para el pensamiento, el tiempo y el juego.',
            sv: 'Mjukvara för tanke, tid och lek.'
        },
        'error.heading': {
